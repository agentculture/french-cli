"""``french overview`` — the subject's self-description (contract: subject_overview).
...
from french.cli._commands.whoami import report
from french.cli._output import emit_result
from french.tutor import curriculum, engine, stories
...
def cmd_overview(args: argparse.Namespace) -> int:
    ...
    if json_mode:
        ...
        emit_result(render_text("french-cli", agent_sections()), json_mode=False)
    return 0
