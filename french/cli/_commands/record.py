"""``french record`` — the driver's write-back (the motivation layer's input).
...
only — it structurally forbids score/grade/points; learn-cli computes scores.
    ...
    french record --learner ori --item fr.numbers.prix --activity practice \\
      --exercise prix-1 --result pass --correct 1 --total 1 --json
"""
