"""The subject-plugin contract, CITED (cite-don't-import) into french-cli.
...
french-cli is a *subject* hosted by learn-cli, not a dependency of it: its
...
here. french-cli validates its own ``--json`` payloads against these schemas in
...
from french.contract_cite._validate import validate as _validate_instance
