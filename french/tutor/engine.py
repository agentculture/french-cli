...
strings are hard-coded here — the French-ness comes from
:mod:`french.tutor.subject`, :mod:`french.tutor.curriculum`, and the story
...
French-specific voice is in ``subject.PERSONA``), which keeps a sibling-language
...
from french.contract_cite import CONTRACT_VERSION
from french.tutor import curriculum, state, stories, subject
